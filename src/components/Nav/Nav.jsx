  ...
  return (
    <nav className="fixed bottom-2 lg:bottom-3 w-full overflow-hidden z-50">
      <div className="container mx-auto ">
        <div className="w-full bg-gray-300/2 h-[70px] backdrop-blur-2xl rounded-full max-w-[460px] mx-auto px-5 flex justify-between items-center text-2xl text-black">
          <Link
            to="home"
            activeClass="active"
            smooth={true}
